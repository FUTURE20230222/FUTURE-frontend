...
const data = [
  {
    ...
    label: 'menu.care-panel',
    to: `${adminRoot}/care-panel`,
    // roles: [UserRole.Admin, UserRole.Editor],
    subs: [
      {
        icon: 'simple-icon-social-steam',
        label: 'menu.qecare',
        to: `${adminRoot}/care-panel/qecare`,
        // roles: [UserRole.Admin],
      },
      {
        icon: 'iconsminds-network',
        label: 'menu.conference',
        to: `${adminRoot}/care-panel/conference`,
        // roles: [UserRole.Admin],
      },
      {
        icon: 'iconsminds-network',
        label: 'menu.map',
        to: `${adminRoot}/care-panel/map`,
        // roles: [UserRole.Admin],
      },
      {
        icon: 'iconsminds-network',
        label: 'menu.testCreateMap',
        to: `${adminRoot}/care-panel/testCreateMap`,
        // roles: [UserRole.Admin],
      },
      {
        icon: 'iconsminds-network',
        label: 'menu.patrol',
        to: `${adminRoot}/care-panel/patrol`,
        // roles: [UserRole.Admin],
      },
    ],
  },
 ...
 //   // roles: [UserRole.Admin, UserRole.Editor],
  ...
  //       icon: 'simple-icon-social-steam',
  //       label: 'menu.robots',
  //       to: `${adminRoot}/robots/robots`,
  //       // roles: [UserRole.Admin],
  //     },
  //     {
  //       icon: 'simple-icon-social-steam',
  //       label: 'menu.default',
  //       to: `${adminRoot}/robots/default`,
  //       // roles: [UserRole.Admin],
  //     }
  //   ],
  // },
