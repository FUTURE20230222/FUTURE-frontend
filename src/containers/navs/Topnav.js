  ...
  const menuList = [
    {
      ...
      path: "patrol",
      icon: "iconsminds-direction-east",
      text: "Patrol"
    },
  ]
    ...
    <nav className="navbar fixed-top">
      <div className="d-flex align-items-center navbar-left">
        ...
        <div style={{ marginLeft: '20px', display: 'flex' }}>
          {menuList.map((elem, i) => (
            <div key={`button-` + i} style={{ marginLeft: '10px', width:'90px'}}>
              <NavLink
                target="_top"
                to={`${adminRoot}/care-panel/${elem.path}`}
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', fontSize: 16 }}
              >
        ...
        {/* <div className="user d-inline-block">
          <UncontrolledDropdown className="dropdown-menu-right">
            <DropdownToggle className="p-0" color="empty">
              ...
              <span>
                <img alt="Profile" src="/assets/logos/144x144-logo.png" />
              </span>
            </DropdownToggle>
            <DropdownMenu className="mt-3" right>
